...
class InferenceAction(Action):
    ...
    def add_arguments(cls: type, parser: argparse.ArgumentParser):
        ...
        parser.add_argument("save_path", metavar="<save_path>", help="save_path data")
        parser.add_argument(
            "--opts",
    ...
    def execute(cls: type, args: argparse.Namespace):
        ...
        for file_name in file_list:
            ...
            with torch.no_grad():
                ...
                cls.execute_on_outputs(context, {"file_name": file_name, "image": img}, outputs, args.save_path)
...
class ShowAction(InferenceAction):
    ...
    @classmethod
    def execute_on_outputs(
        cls: type, context: Dict[str, Any], entry: Dict[str, Any], outputs: Instances, save_path: str
    ):
        import cv2
        import numpy as np
